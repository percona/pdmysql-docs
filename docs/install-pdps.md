...
We gather [Telemetry data on Percona Server for MySQL](https://docs.percona.com/percona-server/8.0/telemetry.html) in the Percona packages and Docker images.
