# Percona Distribution for MySQL 8.0.36 using Percona XtraDB Cluster (2024-04-02)
...
| ProxySQL                | [2.6.0](https://docs.percona.com/proxysql/2.6.0.html)| A high performance, high-availability, protocol-aware proxy for MySQL.          |
