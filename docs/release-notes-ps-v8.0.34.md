...
This release is focused on the Percona Server for MySQL-based deployment variation. It is based on [Percona Server for MySQL 8.0.34-26](https://docs.percona.com/percona-server/8.0/release-notes/8.0.34-26.html).
