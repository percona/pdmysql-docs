...
This release is focused on the *Percona Server for MySQL*-based deployment variant. It is based on [Percona Server for MySQL 8.0.29-21](https://docs.percona.com/percona-server/8.0/release-notes/8.0.29-21.html).
...
| Percona XtraBackup  | [8.0.29-22](https://docs.percona.com/percona-xtrabackup/8.0/release-notes/8.0/8.0.29-22.0.html)| An open-source hot backup utility for MySQL-based servers|
