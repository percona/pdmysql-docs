# Percona Distribution for MySQL 8.4.8 using Percona Server for MySQL (2026-03-12)
...
| MySQL Shell         | [8.4.8](https://dev.mysql.com/doc/relnotes/mysql-shell/8.4/en/news-8-4-8.html)    | An advanced client and code editor for MySQL Server|
| MySQL Router        | [8.4.8](https://dev.mysql.com/doc/relnotes/mysql-router/8.4/en/news-8-4-8.html)    | Lightweight middleware that provides transparent routing between your application and back-end MySQL servers|
