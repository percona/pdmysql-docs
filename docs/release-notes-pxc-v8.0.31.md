...
This release is focused on the Percona XtraDB Cluster-based deployment variation. It is based on [Percona XtraDB Cluster 8.0.31-23](https://docs.percona.com/percona-xtradb-cluster/8.0/release-notes/8.0.31-23.html)
